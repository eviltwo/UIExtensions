...
|InputActionEventTrigger|標準では用意されていない入力イベントを利用できるようになります。L/Rトリガーでページを切り替える際などに便利です。<br>EventRelaySystemにInputActionを登録して、イベントを受け取るUIにこのコンポーネントアタッチしてください。|
